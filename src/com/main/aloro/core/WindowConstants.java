...
public class WindowConstants {
    ...
    /**
     * FPS text showing as [%dfps]. Needs to be formatted to show the number with
     * String.format
     */
    ...
    public final static String WINDOW_TITLE_COMPLETE = WINDOW_TITLE + SPACE + APPLICATION_VERSION + SPACE + INFO_FPS
	    + SPACE + GENERATION;
